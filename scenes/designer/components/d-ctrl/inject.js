import Vue from 'vue';
import { UModal as UModalSource } from 'cloud-ui.kubevue';
...
Vue.component('UModal', {
        ...
        remove() {
            ...
            if (p) {
                this.send({
                    ...
                    nodePath: this.$attrs['kubevue-node-path'],
                });
            }
        },
        send(data) {
    ...
    render(h) {
        ...
        if (!injectSlot) {
            ...
            console.error('The building platform does not allow the use of this slot');
        }
        return h('div', {}, [
            h('u-modal-source', {
                class: this.class,
